...
function Login() {
  ...
  return (
    <div className="min-h-screen text-gray-400 bg-gray-900 flex items-center justify-center relative overflow-hidden">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="bg-gray-800 max-w-md w-full sm:rounded-2xl rounded-none min-h-screen sm:min-h-fit flex flex-col justify-between"
      >
